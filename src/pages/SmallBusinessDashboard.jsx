        ...
        <Layout>
            <div className="max-w-[1200px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    <div onClick={() => handleMetricClick("Total Spending")} className="bento-card flex flex-col gap-4 rounded-xl p-6 bg-white dark:bg-gray-900 border border-primary/30 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
                    ...
                    <div onClick={() => handleMetricClick("Budget Remaining")} className="bento-card flex flex-col gap-4 rounded-xl p-6 bg-white dark:bg-gray-900 border border-status-green/30 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start">
                    ...
                    <div onClick={() => handleMetricClick("Active Orders")} className="bento-card flex flex-col gap-4 rounded-xl p-6 bg-white dark:bg-gray-900 border border-new-blue/30 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
                        <div className="flex justify-between items-start">
                    ...
                    <div className="xl:col-span-2 space-y-6">
                        <div className="flex items-center justify-between px-2">
                            ...
                            <div className="flex gap-2">
                                <Link to="/small-business/orders" className="text-sm font-medium text-primary hover:underline">
                                    View all orders
                                </Link>
                            </div>
                        </div>
                            ...
                            <div className="p-6 flex-1 flex flex-col gap-4">
                                <div className="flex justify-between items-start">
                                    <div className="flex flex-col gap-0.5">
                                        ...
                                        <h3 className="text-lg font-bold">Fresh Farm Supplies Co.</h3>
                                    </div>
                                ...
                                <div className="flex items-center gap-3 pt-2">
                                    <button onClick={() => handleTrackDelivery("ORD-4521")} className="flex-1 bg-status-green text-white h-11 px-4 rounded-lg font-bold text-sm flex items-center justify-center gap-2 hover:brightness-110 transition-all">
                                        <span className="material-symbols-outlined text-lg">
                                            location_on
                                        </span>
                                        Track Delivery
                                    </button>
                                    <button onClick={() => handleViewDetails("ORD-4521")} className="px-4 h-11 rounded-lg border border-gray-200 dark:border-gray-700 text-sm font-bold hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                        View Details
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex-1 flex flex-col gap-4">
                                <div className="flex justify-between items-start">
                                    <div className="flex flex-col gap-0.5">
                                        ...
                                        <h3 className="text-lg font-bold">Premium Coffee Roasters</h3>
                                    </div>
                                ...
                                <div className="flex items-center gap-3 pt-2">
                                    <button onClick={() => handleTrackDelivery("ORD-4518")} className="flex-1 bg-gray-100 dark:bg-gray-800 text-[#121615] dark:text-white h-11 px-4 rounded-lg font-bold text-sm hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                                        Track Shipment
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="p-6 flex-1 flex flex-col gap-4">
                                <div className="flex justify-between items-start">
                                    <div className="flex flex-col gap-0.5">
                                        ...
                                        <h3 className="text-lg font-bold">Dairy Distributors Ltd</h3>
                                    </div>
                                ...
                                <div className="flex items-center gap-3 pt-2">
                                    <button onClick={() => handleContactSupplier("Dairy Distributors Ltd")} className="flex-1 bg-gray-100 dark:bg-gray-800 text-[#121615] dark:text-white h-11 px-4 rounded-lg font-bold text-sm hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                                        Contact Supplier
                                    </button>
                                </div>
                            </div>
                    ...
                    <aside className="space-y-6">
                                ...
                                <div className="flex flex-col gap-3 pb-4 border-b border-gray-50 dark:border-gray-800">
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-400">Current: 2 bags</p>
                                        </div>
                                        <span className="text-xs font-bold text-risk-amber">
                                            Low Stock
                                        </span>
                                    </div>
                                    <button onClick={() => handleReorderNow("Organic Flour 25kg")} className="w-full py-2 bg-primary text-white rounded-lg text-xs font-bold hover:brightness-105 transition-all">
                                        Reorder Now
                                    </button>
                                </div>
                                ...
                                <div className="flex flex-col gap-3 pb-4 border-b border-gray-50 dark:border-gray-800">
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-400">Current: 15 units</p>
                                        </div>
                                        <span className="text-xs font-bold text-risk-amber">
                                            Low Stock
                                        </span>
                                    </div>
                                    <button onClick={() => handleReorderNow("Whole Milk 1L")} className="w-full py-2 bg-primary text-white rounded-lg text-xs font-bold hover:brightness-105 transition-all">
                                        Reorder Now
                                    </button>
                                </div>
                                ...
                                <div className="flex flex-col gap-3 pb-4 border-b border-gray-50 dark:border-gray-800">
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-gray-400">Current: 0 jars</p>
                                        </div>
                                        <span className="text-xs font-bold text-red-500">
                                            Out of Stock
                                        </span>
                                    </div>
                                    <button onClick={() => handleReorderNow("Raw Honey 5kg")} className="w-full py-2 bg-red-500 text-white rounded-lg text-xs font-bold hover:brightness-105 transition-all">
                                        Order Urgently
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm">
                            ...
                            <div className="space-y-3">
                                <button onClick={() => handleQuickReorder("Weekly Essentials")} className="w-full p-3 bg-gray-50 dark:bg-gray-800 rounded-lg text-left hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                    <p className="text-sm font-bold">Weekly Essentials</p>
                                    <p className="text-[10px] text-gray-400">12 items • $450</p>
                                </button>
                                <button onClick={() => handleQuickReorder("Coffee & Tea")} className="w-full p-3 bg-gray-50 dark:bg-gray-800 rounded-lg text-left hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                    <p className="text-sm font-bold">Coffee & Tea</p>
                                    <p className="text-[10px] text-gray-400">5 items • $280</p>
                                </button>
                                <button onClick={() => handleQuickReorder("Dairy Products")} className="w-full p-3 bg-gray-50 dark:bg-gray-800 rounded-lg text-left hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <div className="bg-primary/10 rounded-xl p-6 border border-primary/20">
                            ...
                            <p className="text-xs leading-relaxed text-primary/80">
                                You're spending <strong>15% less</strong> this month compared to last month. Great job managing your budget!
                            </p>
                        </div>
                    </aside>
                </div>
